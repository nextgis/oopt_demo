...
(function() {
  ...
  resetDefaultRenderLoop = function() {
    return viewer.useDefaultRenderLoop = false;
  };

  stopRendering = function() {
    return resetDefaultRenderLoop();
  };

  startRendering = function() {
    if (!viewer.useDefaultRenderLoop) {
      return viewer.useDefaultRenderLoop = true;
    }
  };
