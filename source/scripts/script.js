...
(function() {
  var build_gallery, build_info, build_pups, build_video, build_web, check_time, circleGeometry, cities, close_menu, date, ellipsoid, fly_to_home, geodata, get_oopt_rect, handler, is_globus_moved, is_photo_enable, is_video_enable, load_borders, load_cities, load_geodata, load_np, load_popups_data, load_zp, num_images, oopt, open_menu, open_popup, pole_primitive, popups_data, prepare_popup, primitives, redCircleInstance, scene, selected_polygon_name, settings, showed_image, viewer;
